...
public class AddPatientForm extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        javax.swing.JPanel jPanel1 = new jPanelGradient();
        ...
        jPanel3Layout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel3Layout.createSequentialGroup()
                ...
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(bed, javax.swing.GroupLayout.PREFERRED_SIZE, 367, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(64, 64, 64))
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel3Layout.createSequentialGroup()
                .addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
        ...
        jPanel3Layout.linkSize(javax.swing.SwingConstants.HORIZONTAL, new java.awt.Component[] {patientPhoto, uploadPhotoBtn});
    ...
    private void uploadPhotoBtnActionPerformed(java.awt.event.ActionEvent evt) {                                               
    ...
    private void saveBtnActionPerformed(java.awt.event.ActionEvent evt) {                                        
        ...
        String bedTxt = bed.getText();

        if (name.isEmpty() || age.isEmpty() || caseNumber.isEmpty() || diag.isEmpty() || bedTxt.isEmpty()) {
        ...
        String sql = "INSERT INTO Patient(name, age, caseNumber, diagnosis, photoName, dates, bed) VALUES (?, ?, ?, ?, ?, ?, ?)";
        ...
        try {
            ...
            pst.setString(6, generateDates());
            pst.setString(7, bedTxt);
            pst.executeUpdate();
        ...
        String destination = folder.getAbsolutePath() + File.separator + imageName + ".jpg";
    ...
    private String generateDates() {
        ...
        String dateArrayString = currentDate.plusDays(0).format(FORMATTER).toString();

        for (int i = 1; i < 5; i++) {
            dateArrayString += "," + currentDate.plusDays(i).format(FORMATTER).toString();
        }
